...
for beta in beta_values:
    for g in range(gr):
        ...
        results = results._append({'beta_value': beta, 'bias': bias, 'variance': variance}, ignore_index=True)

sns.set_theme(style="darkgrid")
plt.figure(figsize=(10, 6))
sns.lineplot(data=results, x='beta_value', y='bias', ci='sd', estimator='mean', markers=True, dashes=False)
